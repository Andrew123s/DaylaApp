...
const SustainabilitySetup: React.FC<{ tripId: string; onSetup: () => void }> = ({ tripId, onSetup }) => {
  return (
    <div className="bg-white/80 backdrop-blur-sm rounded-xl p-8 border border-white/20 shadow-sm text-center">
      ...
      <h2 className="text-2xl font-bold text-gray-900 mb-4">Sus Cal - Sustainability Calculator</h2>
      ...
      <button
        onClick={onSetup}
        className="bg-gradient-to-r from-green-600 to-blue-600 text-white px-8 py-3 rounded-lg hover:from-green-700 hover:to-blue-700 transition-all duration-200"
      >
      ...
      <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-8 border border-green-200">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-gray-600 mb-4">Total Carbon Footprint</div>
          ...
          <div className="text-center">
            ...
            <div className={`text-3xl font-bold mb-2 ${comparisonPercentage < 0 ? 'text-green-600' : 'text-red-500'}`}>
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-gray-600 mb-4">Net Impact (After Offsets)</div>
            <div className="text-xs text-gray-500">
          ...
          <div className="space-y-4">
            {sustainability.recommendations?.map((rec: any, index: number) => (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">Great job! Your trip has a low environmental impact.</p>
              </div>
            )}
          </div>
        </div>
...
const TransportComparison: React.FC<{
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-white/20 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-gray-900">Trip Distance</h3>
          <SliderIcon className="h-5 w-5 text-gray-400" />
        </div>
        
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-600">Distance</span>
            <span className="text-lg font-semibold text-gray-900">{distance.toLocaleString()} km</span>
          </div>
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{distance.toLocaleString()} km</p>
                    </div>
                  </div>
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-white/20 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-gray-900">Local Sustainable Transit</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 bg-green-50 rounded-lg border border-green-200">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-600">90% less emissions</p>
              </div>
            </div>
          ...
          <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <div>
                <h4 className="font-medium text-gray-900">Bike Sharing</h4>
                <p className="text-sm text-blue-600">Zero emissions</p>
              </div>
            </div>
            <p className="text-sm text-gray-600">
          ...
          <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <div>
                ...
                <p className="text-sm text-purple-600">80% less emissions</p>
              </div>
            </div>
            <p className="text-sm text-gray-600">
...
const AccommodationAnalyzer: React.FC<{ sustainability: any }> = ({ sustainability }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-white/20 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-gray-900">Accommodation Analysis</h3>
          <Home className="h-5 w-5 text-gray-400" />
        </div>
        
        <div className="space-y-6">
          {accommodations.map((accommodation) => (
            <div key={accommodation.id} className="p-6 bg-gray-50 rounded-lg">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h4 className="text-lg font-semibold text-gray-900">{accommodation.name}</h4>
                  <p className="text-sm text-gray-600 capitalize">{accommodation.accommodation_type.replace('-', ' ')}</p>
                </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {accommodation.certifications.map((cert) => {
                      ...
                      return (
                        <div
                          key={cert}
                          className={`px-3 py-1 bg-${info?.color || 'gray'}-100 text-${info?.color || 'gray'}-800 text-xs rounded-full font-medium`}
              ...
              <div className="mb-4">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium text-gray-900">Seasonal Impact</span>
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-white/20 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-gray-900">Activity Impact Analysis</h3>
          <Activity className="h-5 w-5 text-gray-400" />
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <h4 className="font-medium text-gray-900 mb-4">Low Impact Activities</h4>
            <div className="space-y-3">
              {[
                ...
                <div key={index} className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                  ...
                  <span className="text-sm text-green-600 font-medium">{activity.impact}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            <h4 className="font-medium text-gray-900 mb-4">Higher Impact Activities</h4>
            <div className="space-y-3">
              {[
                ...
                <div key={index} className="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                  ...
                  <span className="text-sm text-red-600 font-medium">{activity.impact}</span>
                </div>
              ))}
            </div>
          </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-6 border border-green-200">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-gray-900">Carbon Neutralization Progress</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-gray-600">Remaining to Neutralize</div>
          </div>
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-white/20 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-gray-900">Curated Offset Projects</h3>
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <div className="font-medium text-gray-900">{project.certification}</div>
                    </div>
                  </div>
                  
                  <div className="mb-4">
                    <div className="text-sm text-gray-600">Impact</div>
                    <div className="font-medium text-gray-900">{project.impact_description}</div>
                  </div>
                  
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <div className="text-sm text-gray-600">Cost per ton CO₂</div>
                      <div className="text-lg font-bold text-gray-900">${project.cost_per_ton}</div>
                    </div>
                    <div className="text-right">
                      <div className="text-sm text-gray-600">Total offset</div>
                      <div className="font-medium text-gray-900">{project.total_offset_tons.toLocaleString()} tons</div>
                    </div>
                  </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-white/20 shadow-sm">
          ...
          <div className="space-y-4">
            {sustainability.offset_contributions.map((contribution: any) => {
              ...
              return (
                <div key={contribution.id} className="flex items-center justify-between p-4 bg-green-50 rounded-lg border border-green-200">
                  ...
                  <div className="text-right">
                    <div className="font-semibold text-gray-900">${contribution.amount_usd}</div>
      ...
      {neutralizationProgress >= 100 && (
        <div className="bg-gradient-to-r from-green-500 to-blue-500 rounded-xl p-6 text-white">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-xl font-bold">🎉 Carbon Neutral Achievement!</h3>
            <div className="flex space-x-2">
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            ...
            <div>
              <div className="text-2xl font-bold">{sustainability.offset_contributions?.length || 0}</div>
              <div className="text-sm opacity-90">Projects Supported</div>
            </div>
            <div>
              <div className="text-2xl font-bold">{Math.round(totalOffset / 22)}</div>
