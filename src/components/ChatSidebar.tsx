          ...
          <div className="flex-1 overflow-y-auto">
            {isLoading ? (
              ...
              <div className="p-8 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">Start chatting with your trip collaborators</p>
                <button
                  onClick={() => setShowCreateChat(true)}
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-md w-full p-6 shadow-2xl">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">Add Friends to Chat</h2>
          <button
            onClick={onClose}
            className="p-2 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition-colors"
          >
          ...
          <div className="flex space-x-4">
            <label className="flex items-center">
              <input
                ...
                className="mr-2"
              />
              <span className="text-sm text-gray-900 dark:text-white">Direct Message</span>
            </label>
            <label className="flex items-center">
              <input
                type="radio"
                ...
                className="mr-2"
              />
              <span className="text-sm text-gray-900 dark:text-white">Group Chat</span>
            </label>
          </div>
        </div>
